"""The convention files Zam reads and wayworks writes.

These filenames are a contract between two separate repositories. Zam's
...
This module is the single place Zam declares what it depends on. The contract
...
# Zam yet (deploy is Phase 3), declared here so the contract covers it before
