...
from cuzam import runner  # noqa: E402
...
class PreserveWorkTest(unittest.TestCase):
    ...
    def test_never_commits_cuzam_run_artifacts(self) -> None:
        """Run logs are not the flow's work product.

        .cuzam/ is untracked in the repos this runs against, so a bare
    ...
    def test_the_commit_carries_a_machine_readable_trailer(self) -> None:
        ...
        self.assertIn("Cuzam-Preserved: build", body)
